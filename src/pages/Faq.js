    ...
    return(
      <div>
        <body style={{backgroundColor: "black"}}>
          ...
          <div classname="info">  
            <p className="inf-faq">
              설문지/오픈채팅방을 통해 질문을 받고 있습니다!<br/>
              재학생용과 외부인용(입학 예정자, 입학 희망자)
              으로 나누어져 있으니 구분하여 작성해주시기 바랍니다.
              대표 질문은 교육부에서 선발 후 FAQs로 게시합니다.
            </p>
            <a><p className="link-in">재학생용</p></a>
            <a><p className="link-out">외부인용</p></a>
          </div>
